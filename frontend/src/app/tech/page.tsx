...
export default function TechInfoPage() {
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="section-title">
          ...
          <p className="mt-3 text-slate-600 max-w-2xl mx-auto text-center">
            Un aperçu clair et visuel des technologies qui propulsent DermaScan.
          </p>
        </div>
  ...
  <div className="mt-6 grid md:grid-cols-3 gap-5 items-stretch">
          <div className="card md:col-span-2 card-soft">
            ...
            <p className="mt-1 text-slate-700">Frontend moderne, API rapide, MLOps fiable et traçabilité complète.</p>
                ...
                <div className="mt-2.5 space-y-2.5">
                  ...
                  <div className="p-3 rounded-lg border border-black/5 bg-white flex items-center justify-between gap-3">
                    <div className="flex items-center gap-2 min-w-0">
                      ...
                      <code className="v-mono text-sm text-slate-700">/api/predict</code>
                      <span className="hint">multipart file</span>
                    </div>
                    <button className="icon-ghost" title="Copier" onClick={() => copy("POST /api/predict (multipart file)") }>
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>
                    </button>
                  </div>
                  <div className="p-3 rounded-lg border border-black/5 bg-white flex items-center justify-between gap-3">
