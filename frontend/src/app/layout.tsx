...
export const metadata: Metadata = {
  title: "DermaScan — Détection précoce du mélanome",
  description:
    "Plateforme Big Data & Deep Learning pour la détection précoce du cancer de la peau à partir d'images dermatologiques.",
};
